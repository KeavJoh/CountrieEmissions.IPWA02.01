...
@Entity
@Table(name="countries_confirmations_table")
@Named
public class UnconfirmCountrie {
	...
	public UnconfirmCountrie() {
	}

	public UnconfirmCountrie(int id, String countrieNameString, String countrieCodeString, BigDecimal impactYear2015,
			BigDecimal impactYear2016, BigDecimal impactYear2017, BigDecimal impactYear2018, BigDecimal impactYear2019,
			BigDecimal impactYear2020, BigDecimal impactYear2021, BigDecimal impactYear2022, Countrie countrie) {
		super();
